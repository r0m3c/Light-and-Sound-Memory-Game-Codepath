...
//Global Variables
var randPattern = []; //to be filled at game start
var patternLength = 8;
var numBtns = 6;
var progress = 0; 
...
function startGame(){
  for (let i = 0; i < patternLength; i++) randPattern[i] = Math.round(Math.random()*numBtns);
...
function winGame(){
  stopGame();
  alert("Congratulations! Today you are a winner.");
}
